...
(function () {
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            ...
            normalizeCssText: function (a, b) {
                var c = [], d, g = CKEDITOR.tools.parseCssText(a, true, b);
                for (d in g)
                    c.push(d + ":" + g[d]);
                c.sort();
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getIndex: function (b) {
            ...
            while (c = c.previousSibling); return a
        },
        ...
        getCommonAncestor: function (b) {
            ...
            do
                if (c.contains(b))
                    return c;
            while (c = c.getParent()); return null
        },
        ...
        getAscendant: function (b, c) {
            ...
            if (!c)
                a = a.parentNode;
            for (; a;) {
                if (a.nodeName && (f = a.nodeName.toLowerCase(),
    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            scrollIntoParent: function (a, b, c) {
                ...
                if (h < 0 || g > 0)
                    l(0, b === true ? h : b === false ? g : h < 0 ? h : g);
                if (c && (k < 0 || d > 0))
                    l(k < 0 ? k : d, 0)
            },
    ...
    (function () {
        function b(a, b) {
            ...
            i = q ? function (a, b) {
                ...
                : p;
            if (this.current)
                d = this.current[e](false, f, i);
            else {
                if (a)
                    d.type == CKEDITOR.NODE_ELEMENT && (d = o > 0 ? d.getChild(o - 1) : i(d, true) === false ? null : d.getPreviousSourceNode(true, f, i));
                else {
                    d = m;
                    if (d.type == CKEDITOR.NODE_ELEMENT && !(d = d.getChild(n)))
                        d = i(m, true) === false ? null : m.getNextSourceNode(true, f, i)
                }
                d && i(d) === false && (d = null)
            }
            for (; d && !this._.end;) {
        ...
        CKEDITOR.dom.element.prototype.getBogus = function () {
            ...
            while (d(a) || e(a) || a.type == CKEDITOR.NODE_ELEMENT && a.getName() in CKEDITOR.dtd.$inline && !(a.getName() in CKEDITOR.dtd.$empty)); return a && (!CKEDITOR.env.ie ? a.is && a.is("br") : a.getText && f.test(a.getText())) ? a : false
        }
    }
    )();
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            getBoundaryNodes: function () {
                ...
                if (b.type == CKEDITOR.NODE_ELEMENT) {
                    d = b.getChildCount();
                    if (d > i)
                        b = b.getChild(i).getPreviousSourceNode(true);
                    else if (d < 1)
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        for (; j || e;) {
                            if (j && !e) {
                                !h && j.equals(i) && (h = true);
                                if (c ? j.isBlockBoundary() : !d.contains(j))
                                    break;
            ...
            shrink: function (a, b, c) {
                if (!this.collapsed) {
                    ...
                    i.guard = function (b, i) {
                        if (l(b))
                            return true;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || i && b.equals(p) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary())
                            return false;
                        ...
                        ;
                    if (k)
                        (d = i[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(d, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
                    if (h) {
                        i.reset();
            ...
            getNextParagraph: function (b) {
                ...
                for (this._.nextNode = null; i;) {
                    var q = 0
                        ...
                        , j = 0;
                    if (z)
                        i.type == CKEDITOR.NODE_TEXT && a.test(i.getText()) && (z = 0);
                    else {
                        var s = i.getName();
                ...
                if (!e) {
                    ...
                    e = e.block;
                    if (!e && i && !this.enforceRealBlocks && q[i.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !i.equals(h.root))
                        e = i;
                        ...
                        this._.nextNode = e.equals(m) ? null : c(h.getBoundaryNodes().endNode, 1, m)
                }
                if (n)
                ...
                if (!this._.nextNode)
                    this._.nextNode = l || e.equals(m) || !m ? null : c(e, 1, m);
                return e
            }
        };
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function (b, c, a) {
            ...
            CKEDITOR.scriptLoader.load(d, function (b, o) {
                if (o.length)
                    throw '[CKEDITOR.resourceManager.load] Resource name "' + g[o[0]].join(",") + '" was not found at "' + o[0] + '".';
                ...
                , g = function (a) {
                    b.call(this, a, function (a) {
                        ...
                        for (k in a) {
                            ...
                            if (!c[k]) {
                                if (n.icons)
                                    for (var i = n.icons.split(","), q = 0; q < i.length; q++)
                                        CKEDITOR.skin.addIcon(i[q], n.path + "icons/" + i[q] + ".png");
                                c[k] = 1
                            }
                            if (o) {
                                o.split && (o = o.split(","));
    ...
    (function () {
        function b(b, i, n) {
            ...
            if (i !== void 0) {
                ...
                if (CKEDITOR.env.ie && CKEDITOR.env.quirks && n == CKEDITOR.ELEMENT_MODE_INLINE)
                    throw Error("Inline element mode is not supported on IE quirks.");
                if (n == CKEDITOR.ELEMENT_MODE_INLINE && !i.is(CKEDITOR.dtd.$editable) || n == CKEDITOR.ELEMENT_MODE_REPLACE && i.is(CKEDITOR.dtd.$nonBodyContent))
                    throw Error('The specified element mode is not supported on element: "' + i.getName() + '".');
                this.element = i;
                this.elementMode = n;
        ...
        function h(a) {
            var b = a.config
                ...
                , n = b.removePlugins;
            if (d)
                var e = RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g")
                    , c = c.replace(e, "")
                    , c = c + ("," + d);
            if (n)
                var g = RegExp("(?:^|,)(?:" + n.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g")
                    , c = c.replace(g, "");
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                for (var f in c) {
                    ...
                    if (h && !a.lang[f]) {
                        ...
                        if (!j.langEntries || !j.langEntries[q])
                            e.push(CKEDITOR.getUrl(j.path + "lang/" + q + ".js"));
                        else {
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function (a) {
                ...
                if (a.length > d)
                    this.onText(a.substring(d, a.length))
            }
        }
    }
    )();
                        ...
                        for (; ;) {
                            ...
                            if (!n.isUnknown && !j.isUnknown && !e[d])
                                if (j.isOptionalClose)
                                    ...
                                    j = g
                                } else if (d in CKEDITOR.dtd.$listItem && !o(d, g))
                                    i.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1);
    ...
    (function () {
        function b(b, c) {
                ...
                return function (i) {
                    if (i.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (e = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(i) !== false : c))
                            if (!t && CKEDITOR.env.ie && i.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
                                e = false;
                            else if (!t && CKEDITOR.env.ie && (document.documentMode > 7 || i.name in CKEDITOR.dtd.tr || i.name in CKEDITOR.dtd.$listItem))
                                e = false;
                            else {
                                e = a(i);
            ...
            var j = {
                elements: {}
            }, t = c == "html", h = CKEDITOR.tools.extend({}, D), q;
            for (q in h)
                "#" in B[q] || delete h[q];
            for (q in h)
                j.elements[q] = i(t, b.config.fillEmptyBlocks !== false);
            j.root = i(t);
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, d) {
                var a = j(a, this.editor), a = n(a), a = o(a), a = a.replace(G, "$1cke:$2"), a = a.replace(Q, "<cke:$1$2></cke:$1>"), a = CKEDITOR.env.opera ? a : a.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), e = this.editor.editable(), f;
            ...
            writeHtml: function (c, a) {
                ...
                if (a) {
                    ...
                    for (; ;) {
                        ...
                        d = e.name;
                        if (!d) {
                            for (var d = 0, m = this.children.length; d < m; d++)
    ...
    (function () {
        CKEDITOR.inline = function (b, c, num) {
    ...
    (function () {
                ...
                insertElement: function (b) {
                    ...
                    for (var c = this.editor, e = c.config.enterMode, f = c.getSelection(), h = f.getRanges(), l = b.getName(), j = CKEDITOR.dtd.$block[l], m, k, B, p = h.length - 1; p >= 0; p--) {
                        ...
                        if (!m.checkReadOnly()) {
                            ...
                            var D, u;
                            if (j)
                                for (; (D = m.getCommonAncestor(0, 1)) && (u = CKEDITOR.dtd[D.getName()]) && (!u || !u[l]);)
                                    if (D.getName() in CKEDITOR.dtd.span)
                                        m.splitElement(D);
                                        ...
                                        m.splitBlock(e == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                            m.insertNode(k);
                            B || (B = k)
                        }
                    }
                    if (B) {
                        ...
                        if (j)
                            if ((b = B.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block))
                                b.getDtd()["#"] ? m.moveToElementEditStart(b) : m.moveToElementEditEnd(B);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in {
                                ...
                                var i = a.getSelection(), b = i.getRanges()[0], f = b.startPath(), o, g, l, c = c == 8;
                                if (i = e(i)) {
                                    a.fire("saveSnapshot");
        ...
        var m = function () {
            ...
            function d(a, c) {
                var e = [], f = a.getChildren(), o = f.count(), g, t = 0, h = j[c], l = !a.is(j.$inline) || a.is("br");
                for (l && e.push(" "); t < o; t++) {
                    g = f.getItem(t);
                ...
                : function () {
                    ...
                    if (!c || !c.rangeCount)
                        ...
                        var c = c.getRangeAt(0)
                            , d = c.startContainer;
                        if (d == c.endContainer && d.nodeType == 1 && c.endOffset - c.startOffset == 1 && m[d.childNodes[c.startOffset].nodeName.toLowerCase()])
                            b = CKEDITOR.SELECTION_ELEMENT
                    }
                    return a.type = b
                }
            ...
            getSelectedElement: function () {
                ...
                var b = this
                    , c = CKEDITOR.tools.tryThese(function () {
                        ...
                        for (var a = b.getRanges()[0], c, d, e = 2; e && (!(c = a.getEnclosedNode()) || !(c.type == CKEDITOR.NODE_ELEMENT && m[c.getName()] && (d = c))); e--)
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        if (l) {
                            ...
                            if (A && A.type == CKEDITOR.NODE_ELEMENT && A.getName() in m && (!A.is("a") || !A.getText()))
                                try {
                            ...
                            for (e = 0; e < a.length; e++) {
                                ...
                                if (b.collapsed && CKEDITOR.env.webkit && f(b)) {
                                    ...
                                    if ((h = j.getNext()) && !j.getPrevious() && h.type == CKEDITOR.NODE_ELEMENT && h.getName() == "br") {
                                        ...
                                        b.moveToPosition(j, CKEDITOR.POSITION_AFTER_END)
                                }
                                k.setStart(b.startContainer.$, b.startOffset);
                                try {
    ...
    (function () {
                        ...
                        if (!r || i[r] && !s && (!q || h) && (k.getPosition(m) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(k))) {
                            ...
                            if (u && ((u.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(u))) {
                                ...
                                if (p == CKEDITOR.NODE_TEXT || q || p == CKEDITOR.NODE_ELEMENT && !k.getChildCount()) {
                                    for (var p = k, v; (g = !p.getNext(F)) && (v = p.getParent(),
                                        i[v.getName()]) && (v.getPosition(j) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(v));)
                                        p = v;
                                    n.setEndAfter(p)
                                }
                            } else
                        ...
                        for (var g = y(this, c), q = g.hasAttributes(), s = n.getCommonAncestor(), p = {}, r = {}, u = {}, z = {}, A, B, D; g && s;) {
                            if (s.getName() == d) {
                                for (A in e.attributes)
                                    if (!z[A] && (D = s.getAttribute(B)))
                                        g.getAttribute(A) == D ? r[A] = 1 : z[A] = 1;
                                for (B in e.styles)
                                    if (!u[B] && (D = s.getStyle(B)))
                                        g.getStyle(B) == D ? p[B] = 1 : u[B] = 1
                            }
                            s = s.getParent()
                        }
                        for (A in r)
        ...
        function k(a, b) {
            ...
            if (d && !e) {
                ...
                f ? b = m(c ? [a.getHtml()] : h(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, i;
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (c, e) {
            ...
            while (h = h.getParent()); this.block = d;
            this.blockLimit = g;
            this.root = e;
            this.elements = k
        }
...
*/
        ...
        function V(a) {
            ...
            if (f != CKEDITOR.DIALOG_RESIZE_NONE) {
                var k = a.getParentEditor(), m, j, h, o, i, n = CKEDITOR.tools.addFunction(function (f) {
                    ...
                    g.$.getElementsByTagName("iframe").length && (i = CKEDITOR.dom.element.createFromHtml('<div class="cke_dialog_resize_cover" style="height: 100%; position: absolute; width: 100%;"></div>'),
                        g.append(i));
                    ...
                    CKEDITOR.env.ie6Compat && (g = r.getChild(0).getFrameDocument(),
                        g.on("mousemove", e),
                        g.on("mouseup", d));
        ...
        CKEDITOR.dialog = function (a, b) {
            ...
            function e(a) {
                ...
                if (!(1 > b.length)) {
                    ...
                    for (var f = c = (c + a + b.length) % b.length; a && !b[f].isFocusable() && !(f = (f + a + b.length) % b.length,
                        f == c);)
                        ;
                    b[f].focus();
                ...
                if (l == CKEDITOR.dialog._.currentTop) {
                    ...
                    if (9 == c || c == CKEDITOR.SHIFT + 9)
                        c = c == CKEDITOR.SHIFT + 9,
                            l._.tabBarMode ? (c = c ? p.call(l) : u.call(l),
                                l.selectPage(c),
                                l._.tabs[c][0].focus()) : e(c ? -1 : 1),
                            o = 1;
                        ...
                        if (!c.is("a", "button", "select", "textarea") && (!c.is("input") || "button" != c.$.type))
                            (c = this.getButton("ok")) && CKEDITOR.tools.setTimeout(c.click, 0, c),
                                o = 1;
                        i = 1
                    } else if (27 == c)
            ...
            this.on("cancel", function (b) {
                C(function (c) {
                    if (c.isChanged())
                        return confirm(a.lang.common.confirmCancel) || (b.data.hide = !1),
                            !0
                })
            }, this, null, 0);
        ...
        CKEDITOR.dialog.prototype = {
            ...
            move: function (a, b, c) {
                ...
                if (!g || !this._.position || !(this._.position.x == a && this._.position.y == b))
                    this._.position = {
                        ...
                        g || (g = CKEDITOR.document.getWindow().getScrollPosition(),
                            a += g.x,
                            b += g.y),
                        d && (g = this.getSize(),
            ...
            show: function () {
                ...
                null === CKEDITOR.dialog._.currentTop ? (CKEDITOR.dialog._.currentTop = this,
                    ...
                    J(this._.editor)) : (this._.parentDialog = CKEDITOR.dialog._.currentTop,
            ...
            selectPage: function (a) {
                if (this._.currentTabId != a && !0 !== this.fire("selectPage", {
                    ...
                    CKEDITOR.env.ie6Compat || CKEDITOR.env.ie7Compat ? (q(d[1]),
                        d[1].show(),
                        setTimeout(function () {
                            q(d[1], 1)
                        }, 0)) : d[1].show();
            ...
            CKEDITOR.ui.dialog = {
                uiElement: function (a, b, c, e, d, g, f) {
                    if (!(4 > arguments.length)) {
                        ...
                        this.keyboardFocusable && (this.tabIndex = b.tabIndex || 0,
                    ...
                    return function () {
                        ...
                        for (g = 0; g < a.length; g++)
                            if ("function" == typeof a[g])
                                ...
                                break;
                        g < a.length && "string" == typeof a[g] && (c = a[g],
                            g++);
    ...
    CKEDITOR.plugins.add("basicstyles", {
        init: function (c) {
            var f = 0
                , a = function (a, d, b, e) {
                    e && (e = new CKEDITOR.style(e),
                        c.attachStyleStateChange(e, function (a) {
                            !c.readOnly && c.getCommand(b).setState(a)
                        }),
                        c.addCommand(b, new CKEDITOR.styleCommand(e)),
                        c.ui.addButton && c.ui.addButton(a, {
                            label: d,
                            command: b,
    ...
    (function () {
                    ...
                    if (a == CKEDITOR.TRISTATE_OFF) {
                        ...
                        for (d = {}; 0 < b.length;)
                            f = b.shift(),
                                ...
                                c.getCustomData("blockquote_processed") || (e.push(c),
        ...
        CKEDITOR.plugins.add("blockquote", {
            init: function (g) {
                g.blockless || (g.addCommand("blockquote", k),
    ...
    (function () {
        function v(b) {
            function a() {
                ...
                CKEDITOR.env.ie && (e.on("contextmenu", h, null, null, 0),
                    e.on("beforepaste", function (b) {
            ...
            function k(a, c) {
                ...
                if (!d.getById("cke_pastebin")) {
                    ...
                    var g = 0
                        , d = d.getWindow();
                    f ? (i.insertAfter(o[0].startNode),
                        i.setStyle("display", "inline")) : (CKEDITOR.env.webkit ? (j.append(i),
                            g = (j.is("body") ? j : CKEDITOR.dom.element.get(i.$.offsetParent)).getDocumentPosition().y) : j.getAscendant(CKEDITOR.env.ie || CKEDITOR.env.opera ? "body" : "html", 1).append(i),
                            i.setStyles({
                                position: "absolute",
                    ...
                    (f = i.getParent().isReadOnly()) ? (i.setOpacity(0),
                        i.setAttribute("contenteditable", !0)) : i.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-1000px");
            ...
            b.getClipboardData = function (a, c) {
                ...
                !1 === o() && (b.removeListener("paste", d),
                    k && b.fire("pasteDialog", f) ? (b.on("pasteDialogCommit", j),
            ...
            init: function (b) {
                ...
                b.on("paste", function (a) {
                    ...
                    if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
                        ...
                        for (g.setHtml(b); 1 == g.getChildCount() && (h = g.getFirst()) && (h.hasClass("cke_editable") || h.hasClass("cke_contents"));)
                            g = l = h;
                    ...
                    //zm周满：20180320：解决复制内容包含下划线的问题---start---
                    if (b.indexOf('<u>') !== -1) {
                        b = b.replace(/<u.*?>/g,'##ustart##');
                        b = b.replace(/<\/u>/g,'##uend##');
                    }
                    //zm周满：20180320：解决复制内容包含下划线的问题---end---
                ...
                b.on("paste", function (a) {
                    ...
                    //zm周满：20180320：解决复制内容包含下划线的问题---start---
                    var _html = a.dataValue;
                    if (_html.indexOf('##ustart##') !== -1) {
                        _html = _html.replace(/##ustart##/g,'<u>');
                        _html = _html.replace(/##uend##/g,'</u>');
                    }
                    //zm周满：20180320：解决复制内容包含下划线的问题---end---    

                    //zm周满：20180321：添加块级分割线（帮助说明）---start---
                    // _html = _html.replace(/<\/p>/g,'</p><p><hr></p>');
                    //zm周满：20180321：添加块级分割线（帮助说明）---end---    

                    b.insertHtml(_html, a.type);
                    setTimeout(function () {
                        b.fire("afterPaste")
                    }, 0)
                }, null, null, 1E3);
    ...
    (function () {
        ...
        CKEDITOR.ui.panel.prototype = {
            ...
            showBlock: function (a) {
                ...
                b && (c.removeAttributes(b.attributes),
                    b.hide());
    ...
    (function () {
        function p(a, b, c, g, i) {
            var i = CKEDITOR.tools.genKey(b.getUniqueId(), c.getUniqueId(), a.lang.dir, a.uiColor || "", g.css || "", i || "")
                , e = h[i];
            e || (e = h[i] = new CKEDITOR.ui.panel(b, g),
                e.element = c.append(CKEDITOR.dom.element.createFromHtml(e.render(a), b)),
                e.element.setStyles({
                    display: "none",
                    position: "absolute"
                }));
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                showBlock: function (a, b, c, g, i) {
                    ...
                    this._.blurSet || (b = CKEDITOR.env.ie ? a : new CKEDITOR.dom.window(a.$.contentWindow),
                        CKEDITOR.event.useCapture = !0,
            ...
            if (!1 !== a.resize_enabled) {
                var c = null
                    ...
                    , k = function () {
                        ...
                        b.document && (b.document.removeListener("mousemove", j),
                    ...
                    , p = CKEDITOR.tools.addFunction(function (e) {
                        ...
                        b.document && (b.document.on("mousemove", j),
            ...
            render: function (a, b) {
                ...
                var c = {
                    ...
                    , q = CKEDITOR.tools.addFunction(function () {
                        if (CKEDITOR.env.opera) {
                            var b = a.editable();
                            b.isInline() && b.hasFocus && (a.lockSelection(),
                                j = 1)
                        }
                    });
                ...
                if (this.modes) {
                    var k = {}
                        , g = function () {
                            var b = a.mode;
                            b && (b = this.modes[b] ? void 0 != k[b] ? k[b] : CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
                    ...
                    switch (d) {
                        ...
                        case CKEDITOR.SHIFT + 9:
                            for (; !b || !b.items.length;)
                                if (b = 9 == d ? (b ? b.next : c.toolbar.next) || a.toolbox.toolbars[0] : (b ? b.previous : c.toolbar.previous) || a.toolbox.toolbars[a.toolbox.toolbars.length - 1],
                                    b.items.length)
                        ...
                        case 40:
                            ...
                            while (b && !b.focus); b ? b.focus() : h(c, 9);
                            return !1;
                        case g ? 39 : 37:
                        case 38:
                            b = c;
                            ...
                            while (b && !b.focus); b ? b.focus() : (e = 1,
                                h(c, CKEDITOR.SHIFT + 9),
                                e = 0);
                            return !1;
                        case 27:
                            return a.focus(),
                                        ...
                                        if (!(b && 0 <= CKEDITOR.tools.indexOf(b, k)) && (k = a.ui.create(k)))
                                            if (k.type == CKEDITOR.UI_SEPARATOR)
                                                ...
                                                if (!i) {
                                                    ...
                                                    var p = o.push(i) - 1;
                                                    0 < p && (i.previous = o[p - 1],
                                                        i.previous.next = i)
                                                }
                                                u ? f || (g.push('<span class="cke_toolgroup" role="presentation">'),
                                                    f = 1) : f && (g.push("</span>"),
                                                        f = 0);
                                                j = function (b) {
                                                    b = b.render(a, g);
                            ...
                            a.addCommand("toolbarCollapse", {
                                ...
                                exec: function (a) {
                                    ...
                                    h ? (c.show(),
                                        ...
                                        b.setAttribute("title", a.lang.toolbar.toolbarCollapse)) : (c.hide(),
        ...
        CKEDITOR.ui.prototype.addToolbarGroup = function (a, e, h) {
            ...
            if (h) {
                if (h = CKEDITOR.tools.search(c, function (a) {
                    ...
                    !h.groups && (h.groups = []);
                    if (e && (e = CKEDITOR.tools.indexOf(h.groups, e),
                        0 <= e)) {
                ...
                var q = CKEDITOR.tools.addFunction(d)
                    , r = CKEDITOR.tools.addFunction(function (b, e) {
                        ...
                        switch (e.getKeystroke()) {
                            ...
                            case f ? 37 : 39:
                            case CKEDITOR.SHIFT + 9:
                                return (f = CKEDITOR.document.getById(c + (b - 1))) || (f = CKEDITOR.document.getById(c + (a._.elementsPath.list.length - 1))),
                                    f.focus(),
                                    !1;
                            case 27:
                                return a.focus(),
    ...
    (function () {
        function C(c, j, f) {
            ...
            for (h = 0; h < e.length; h++)
                g = e[h].getCustomData("listarray_index"),
                    i[g].indent = -1;
        ...
        function y(c, j, f, b) {
            for (var i, e; i = c[b ? "getLast" : "getFirst"](D);)
                (e = i.getDirection(1)) !== j.getDirection(1) && i.setAttribute("dir", e),
                    i.remove(),
        ...
        function A(c) {
            ...
            (j = function (f) {
                ...
                b && (b.type == CKEDITOR.NODE_ELEMENT && b.is(c.getName())) && (y(c, b, null, !f),
                    c.remove(),
                    c = b)
            }
            )();
        ...
        function v(c, j, f) {
            ...
            if (a && (b = w(a)))
                e.contains(a) ? (y(b, a.getParent(), a),
                    b.remove()) : e.append(b);
            for (; f.checkStartOfBlock() && f.checkEndOfBlock();)
                g = f.startPath(),
                    b = g.block,
                    b.is("li") && (e = b.getParent(),
            ...
            listToArray: function (c, j, f, b, i) {
                ...
                for (var e = 0, h = c.getChildCount(); e < h; e++) {
                    ...
                    if ("li" == g.$.nodeName.toLowerCase()) {
                        ...
                        i ? a.grandparent = i : (a.grandparent = c.getParent(),
                            a.grandparent && "li" == a.grandparent.$.nodeName.toLowerCase() && (a.grandparent = a.grandparent.getParent()));
            ...
            arrayToList: function (c, j, f, b, i) {
                ...
                for (var e, h = c[f].parent.getDocument(), g = new CKEDITOR.dom.documentFragment(h), a = null, d = f, m = Math.max(c[f].indent, 0), k = null, n, l, p = b == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                    ...
                    if (o.indent == m) {
                        ...
                        r[e.getName()] ? (k = o.element.clone(!1, !0),
                            n != e.getDirection(1) && k.setAttribute("dir", n)) : k = new CKEDITOR.dom.documentFragment(h);
                        ...
                        k.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && d != c.length - 1 && ((n = k.getLast()) && (n.type == CKEDITOR.NODE_ELEMENT && "_moz" == n.getAttribute("type")) && n.remove(),
                            (!k.getLast(q) || !(n.type == CKEDITOR.NODE_ELEMENT && n.getName() in CKEDITOR.dtd.$block)) && k.append(h.createElement("br")));
                ...
                if (j)
                    for (c = g.getFirst(); c;) {
                        if (c.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(j, c),
                            c.getName() in CKEDITOR.dtd.$listItem && (f = c,
                                h = i = b = void 0,
                                b = f.getDirection()))) {
            ...
            exec: function (c) {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                    ...
                    if (i.getFirst(q)) {
                        ...
                        j.enterMode == CKEDITOR.ENTER_BR ? i.appendBogus() : b[0].fixBlock(1, j.enterMode == CKEDITOR.ENTER_P ? "p" : "div"),
                            f.selectRanges(b)
                }
                for (var j = f.createBookmarks(!0), i = [], h = {}, b = b.createIterator(), g = 0; (e = b.getNextRange()) && ++g;) {
                    ...
                    for (e.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; a = e.getNextParagraph();)
                        if (!a.getCustomData("list_block")) {
                            ...
                            m || (m = k,
                                m.getCustomData("list_group_object_" + g) ? m.getCustomData("list_group_object_" + g).contents.push(a) : (d = {
                                    root: m,
                                    contents: [a]
                                },
                                    CKEDITOR.dom.element.setMarker(h, m, "list_group_object_" + g, d),
                                    i.push(d)))
                        }
                }
                for (n = []; 0 < i.length;)
                    if (d = i.shift(),
                        ...
                        if (r[d.root.getName()]) {
                            ...
                            g = [];
                            1 == k.length && k[0].equals(a.root) && (d = b.createElement("div"),
                            ...
                            if (!(1 > g.length)) {
                                ...
                                for (p = e = void 0; g.length;)
                                    e = g.shift(),
                                        ...
                                        e.is("pre") || G.test(e.getName()) ? e.appendTo(p) : (e.copyAttributes(p),
                                            d && e.getDirection() && (p.removeStyle("direction"),
        ...
        CKEDITOR.plugins.add("list", {
            init: function (c) {
                c.blockless || (c.addCommand("numberedlist", new x("numberedlist", "ol")),
    ...
    (function () {
        ...
        p.prototype = {
            ...
            refresh: function (d, i) {
                ...
                a ? this.setState(CKEDITOR.TRISTATE_OFF) : !this.useIndentClasses && "indent" == this.name ? this.setState(CKEDITOR.TRISTATE_OFF) : f ? this.useIndentClasses ? (a = f.$.className.match(this.classNameRegex),
                    f = 0,
                    a && (a = a[1],
                        f = this.indentClassMap[a]),
                    "outdent" == this.name && !f || "indent" == this.name && f == d.config.indentClasses.length ? this.setState(CKEDITOR.TRISTATE_DISABLED) : this.setState(CKEDITOR.TRISTATE_OFF)) : (a = parseInt(f.getStyle(r(f)), 10),
                        isNaN(a) && (a = 0),
                        0 >= a ? this.setState(CKEDITOR.TRISTATE_DISABLED) : this.setState(CKEDITOR.TRISTATE_OFF)) : this.setState(CKEDITOR.TRISTATE_DISABLED)
            },
            exec: function (d) {
                function i(n) {
                    ...
                    if (h && b) {
                        ...
                        if (!(1 > h.length)) {
                            ...
                            for (b = h.getCustomData("listarray_index") + 1; b < a.length && a[b].indent > k; b++)
                                a[b].indent += c;
                ...
                for (var e = this, o = {}, g = d.getSelection(), v = g.createBookmarks(1), l, p = (g && g.getRanges(1)).createIterator(); l = p.getNextRange();) {
                    for (var j = l.getCommonAncestor(); j && !(j.type == CKEDITOR.NODE_ELEMENT && m[j.getName()]);)
                        j = j.getParent();
                    if (!j) {
                        var k = l.getEnclosedNode();
                        k && (k.type == CKEDITOR.NODE_ELEMENT && k.getName() in m) && (l.setStartAt(k, CKEDITOR.POSITION_AFTER_START),
                            l.setEndAt(k, CKEDITOR.POSITION_BEFORE_END),
                            j = k)
                    }
                    j && (l.startContainer.type == CKEDITOR.NODE_ELEMENT && l.startContainer.getName() in m) && (k = new CKEDITOR.dom.walker(l),
                        k.evaluator = q,
                        l.startContainer = k.next());
                    j && (l.endContainer.type == CKEDITOR.NODE_ELEMENT && l.endContainer.getName() in m) && (k = new CKEDITOR.dom.walker(l),
                        k.evaluator = q,
        ...
        CKEDITOR.plugins.add("indent", {
            ...
            init: function (d) {
                d.blockless || (d.addCommand("indent", new p(d, "indent")),
                    d.addCommand("outdent", new p(d, "outdent")),
                    d.ui.addButton && (d.ui.addButton("Indent", {
    ...
    (function () {
        function m(a, d, b) {
            ...
            a.elementPath().isContextFor("p") || (d = CKEDITOR.ENTER_BR,
                b = 1);
            a.fire("saveSnapshot");
                    ...
                    if (l) {
                        ...
                        if (!j && !h) {
                            ...
                            if (d) {
                                ...
                                a && (e = a.clone());
                            e ? i && !e.is("li") && e.renameNode(c) : g && g.is("li") ? e = g : (e = f.createElement(c),
                            ...
                            if (f = l.elementPath) {
                                ...
                                for (g = f.elements.length; i < g; i++) {
                                    ...
                                    if (k.equals(f.block) || k.equals(f.blockLimit))
                                        break;
                                    CKEDITOR.dtd.$removeEmpty[k.getName()] && (k = k.clone(),
                                        e.moveChildren(k),
                                        e.append(k))
                                }
                            }
                            ...
                            if (CKEDITOR.env.ie && j && (!h || !d.getChildCount()))
                                b.moveToElementEditStart(h ? d : e),
                                    b.select();
            ...
            enterBr: function (a, d, b, i) {
                if (b = b || p(a)) {
                    var f = b.document
                        ...
                        , c = h.block
                        , h = c && h.block.getName();
                    !i && "li" == h ? o(a, d, b, i) : (!i && j && q.test(h) ? (j = c.getDirection()) ? (f = f.createElement("div"),
                        f.setAttribute("dir", j),
                        f.insertAfter(c),
                        b.setStart(f, 0)) : (f.createElement("br").insertAfter(c),
                            CKEDITOR.env.gecko && f.createText("").insertAfter(c),
                            b.setStartAt(c.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (c = "pre" == h && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? f.createText("\r") : f.createElement("br"),
                                b.deleteContents(),
                                b.insertNode(c),
                                CKEDITOR.env.ie ? b.setStartAt(c, CKEDITOR.POSITION_AFTER_END) : (f.createText("﻿").insertAfter(c),
    ...
    (function () {
        ...
        function j(a, c, d, b) {
            ...
            for (g in b)
                if (e = b[g],
                    ("hbox" == e.type || "vbox" == e.type || "fieldset" == e.type) && j(a, c, d, e.children),
                    e.filebrowser)
        ...
        function n(a) {
            var e, f = a.config, n = f.floatSpaceDockedOffsetX || 0, m = f.floatSpaceDockedOffsetY || 0, u = f.floatSpacePinnedOffsetX || 0, o = f.floatSpacePinnedOffsetY || 0, h = function (d) {
                ...
                var l = a.editable()
                    ...
                    , q = t("left");
                if (e) {
                    if ("top" == e && i.top < o ? j("pin") : "pin" == e ? b.top > m + k ? j("top") : b.bottom - i.bottom < k && j("bottom") : "bottom" == e && (b.top > m + k ? j("top") : b.bottom > 2 * k + o && j("pin")),
                        p) {
        ...
        CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                render: function (a, d) {
                    ...
                    var k = CKEDITOR.tools.addFunction(function (a, d) {
                        ...
                        , m = CKEDITOR.tools.addFunction(function () {
                            if (CKEDITOR.env.opera) {
                                var c = a.editable();
                                c.isInline() && c.hasFocus && (a.lockSelection(),
                                    i = 1)
                            }
                        });
                    c.keyDownFn = k;
                ...
                setValue: function (a, d) {
                    ...
                    b && (!a && !d ? (d = this.label,
                        b.addClass("cke_combo_inlinelabel")) : b.removeClass("cke_combo_inlinelabel"),
                        b.setText("undefined" != typeof d ? d : a))
                },
                getValue: function () {
                    return this._.value || ""
                },
                ...
                setState: function (a) {
                    this._.state != a && (this.document.getById("cke_" + this.id).setState(a, "cke_combo"),
                        this._.state = a)
                },
                enable: function () {
        ...
        proto: {
            ...
            openTagClose: function (b, a) {
                ...
                a ? (this._.output.push(this.selfClosingEnd),
                    c && c.breakAfterClose && (this._.needsSpace = c.needsSpace)) : (this._.output.push(">"),
    ...
    (function () {
        function n(a) {
            ...
            CKEDITOR.env.gecko && (b.contentEditable = !1,
                2E4 > CKEDITOR.env.version && (b.innerHTML = b.innerHTML.replace(/^.*<\!-- cke-content-start --\>/, ""),
                    setTimeout(function () {
            ...
            this.setup();
            CKEDITOR.env.ie && (d.getDocumentElement().addClass(d.$.compatMode),
        ...
        function q() {
            ...
            if (8 <= CKEDITOR.document.$.documentMode) {
                ...
                CKEDITOR.env.gecko && (a.push("html{height:100% !important}"),
                    ...
                    setData: function (a, c) {
                        ...
                        if (c)
                            ...
                            e ? (/<body[\s|>]/.test(a) || (a = "<body>" + a),
                                ...
                                a = f + a) : a = b.docType + '<html dir="' + b.contentsLangDirection + '" lang="' + (b.contentsLanguage || d.langCode) + '"><head><title>' + this._.docTitle + "</title>" + h + g + "</head><body" + (b.bodyId ? ' id="' + b.bodyId + '"' : "") + (b.bodyClass ? ' class="' + b.bodyClass + '"' : "") + ">" + a + "</body></html>";
                    ...
                    if (d) {
                        if ("left" == a || "right" == a)
                            d.on("exec", function (d) {
                                var c = e(b), h;
                                c && (h = f(c),
                                    h == a ? (c.removeStyle("float"),
                                        a == f(c) && c.removeAttribute("align")) : c.setStyle("float", a),
                                    d.cancel())
                            });
                    ...
                    a: function (a) {
                        ...
                        if (CKEDITOR.plugins.link.synAnchorSelector) {
                            ...
                            if (c.name && (!e || 0 > e.indexOf(a)))
                                c["class"] = (e || "") + " " + a;
                            d && CKEDITOR.plugins.link.emptyAnchorFix && (c.contenteditable = "false",
    ...
    CKEDITOR.plugins.link = {
        getSelectedLink: function (b) {
            ...
            return c && c.is("a") ? c : (a = a.getRanges(!0)[0]) ? (a.shrink(CKEDITOR.SHRINK_TEXT),
                b.elementPath(a.getCommonAncestor()).contains("a", 1)) : null
        },
    ...
    (function () {
        ...
        function $(a) {
            ...
            o(d, {
                ...
                place: function () {
                    ...
                    k.equals(d) ? (g.left = b.scroll.x,
                        g.right = -b.scroll.x,
                        g.width = "") : (g.left = j.size.left - j.size.margin.left + b.scroll.x - (a.inInlineMode ? b.editable.left + b.editable.border.left : 0),
                            g.width = j.size.outerWidth + j.size.margin.left + j.size.margin.right + b.scroll.x,
                            g.right = "");
                    ...
                    c.is(u) || g.top > b.scroll.y - 15 && g.top < b.scroll.y + 5 ? (g.top = a.inInlineMode ? 0 : b.scroll.y,
                        this.look(u)) : c.is(v) || g.top > b.pane.bottom - 5 && g.top < b.pane.bottom + 15 ? (g.top = a.inInlineMode ? b.editable.height + b.editable.padding.top + b.editable.padding.bottom : b.pane.bottom - 1,
                            this.look(v)) : (a.inInlineMode && (g.top -= b.editable.top + b.editable.border.top),
                                this.look(q));
                    a.inInlineMode && (g.top-- ,
                        g.top += b.editable.scroll.top,
                        g.left += b.editable.scroll.left);
                    for (var O in g)
                        g[O] = CKEDITOR.tools.cssLength(g[O]);
                    this.setStyles(g)
                },
                look: function (a) {
                    if (this.oldLook != a) {
        ...
        function P(a, b) {
            ...
            p.ie && a.enterMode == CKEDITOR.ENTER_BR ? f = a.doc.createText(G) : (f = new F(a.enterBehavior, a.doc),
        ...
        function R(a) {
            ...
            if (!l(b) || n(b) || !B(a, b))
                return null;
            m(a, b);
            return !c && 0 <= b.size.top && 0 < d.y && d.y < b.size.top + f ? (a = a.inInlineMode || 0 === e.scroll.y ? u : q,
                new s([null, b, A, C, a])) : c && b.size.bottom <= e.pane.height && d.y > b.size.bottom - f && d.y < e.pane.height ? (a = a.inInlineMode || b.size.bottom > e.pane.height - f && b.size.bottom < e.pane.height ? v : q,
                    new s([b, null, S, C, a])) : null
        }
        function T(a) {
            var b = a.mouse
                , d = a.view
            ...
            if (b.y > f.size.top - 1 && b.y < f.size.top + e)
                ...
                return null;
            if (n(f) || aa(a, f, i) || f.getParent().is(U))
                return null;
            var j = L(a, f, !i);
            if (j) {
                if (j && j.type == CKEDITOR.NODE_TEXT)
                    return null;
                if (l(j)) {
                    if (n(j) || !B(a, j) || j.getParent().is(U))
                        return null;
                    c = [j, f][i ? "reverse" : "concat"]().concat([H, C])
                }
            } else
                f.equals(a.editable[i ? "getLast" : "getFirst"](a.isRelevant)) ? (z(a),
                    i && b.y > f.size.bottom - e && b.y < d.pane.height && f.size.bottom > d.pane.height - e && f.size.bottom < d.pane.height ? h = v : 0 < b.y && b.y < f.size.top + e && (h = u)) : h = q,
        ...
        function I(a, b, d, e) {
            ...
            }(), c = b.getDocumentPosition(), h = {}, i = {}, j = {}, k = {}, g = r.length; g--;)
                h[r[g]] = parseInt(f("border-" + r[g] + "-width"), 10) || 0,
                    j[r[g]] = parseInt(f("padding-" + r[g]), 10) || 0,
                    i[r[g]] = parseInt(f("margin-" + r[g]), 10) || 0;
            (!d || e) && D(a, e);
        ...
        function m(a, b, d) {
            if (!l(b))
                return b.size = null;
            if (b.size) {
                if (b.size.ignoreScroll == d && b.size.date > new Date - V)
                    return null
            } else
                b.size = {};
                ...
                a.on("contentDom", function () {
                    ...
                    b.is(CKEDITOR.dtd.$inline) || (c.inInlineMode && !Q(b) && b.setStyles({
                        ...
                        b.attachListener(a, "beforeGetData", function () {
                            c.line.wrap.getParent() && (c.line.detach(),
                                a.once("getData", function () {
                                    c.line.attach()
                                }, null, null, 1E3))
                        }, null, null, 0),
                        b.attachListener(c.inInlineMode ? d : d.getWindow().getFrame(), "mouseout", function (b) {
                            if ("wysiwyg" == a.mode)
                                if (clearTimeout(i),
                                    c.inInlineMode) {
                        ...
                        b.attachListener(c.inInlineMode ? b : d, "mousemove", function (b) {
                            ...
                            if (!("wysiwyg" != a.mode || k)) {
                                ...
                                k = setTimeout(function () {
                                    ...
                                    k = c.trigger = null;
                                    D(c);
                                    if (j && !c.hiddenMode && a.focusManager.hasFocus && !c.line.mouseNear() && (c.element = W(c, !0)))
                                        (c.trigger = R(c) || T(c) || X(c)) ? c.line.attach().place() : (c.trigger = null,
                                            c.line.detach()),
                                            j = !1
                                }, 30)
                            }
                        ...
                        b.attachListener(e, "scroll", function () {
                            "wysiwyg" == a.mode && (c.line.detach(),
                                p.webkit && (c.hiddenMode = 1,
                                    clearTimeout(h),
            ...
            , X = function () {
                function a(a) {
                    ...
                    if (!(a.mouse.y > f.size.top && a.mouse.y < c.size.bottom))
                        return null;
                    for (var e = Number.MAX_VALUE, i, j, k, g; c && !c.equals(f) && (j = f.getNext(a.isRelevant));)
                        i = Math.abs(Z(a, f, j) - a.mouse.y),
                            i < e && (e = i,
                                k = f,
                                g = j),
                            f = j,
    ...
    (function () {
        function l(a) {
            ...
            for (var e = [], f = ["style", "className"], b = 0; b < f.length; b++) {
                ...
                d && (d = new CKEDITOR.dom.element(d),
                ...
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    ...
                    a.addCommand("maximize", {
                        ...
                        exec: function () {
                            ...
                            "wysiwyg" == a.mode ? j ? (CKEDITOR.env.gecko && q(a),
                ...
                a.on("paste", function (f) {
                    ...
                    if (c && (b || /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(c))) {
                        var g = h(e, function () {
                            if (g)
                                a.fire("paste", d);
                            else if (!a.config.pasteFromWordPromptCleanup || b || confirm(a.lang.pastefromword.confirmCleanup))
                                d.dataValue = CKEDITOR.cleanWord(c, a)
                        });
                        g && f.cancel()
                    }
                }, null, null, 3)
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("stylescombo", {
            ...
            init: function (b) {
                    ...
                    b.getStylesSet(function (g) {
                        if (!i.length) {
                            for (var c, l, e = 0, f = g.length; e < f; e++)
                                c = g[e],
                                    b.blockless && c.element in CKEDITOR.dtd.$block || (l = c.name,
                                        c = h[l] = new CKEDITOR.style(c),
                                        c._name = l,
                                        c._.enterMode = k.enterMode,
                                        i.push(c));
                            i.sort(m)
                        }
                        a && a()
                ...
                var k = b.config, f = b.lang.stylescombo, h = {}, i = [], d;
                b.ui.addRichCombo("Styles", {
                        ...
                        j(function () {
                            ...
                            for (h = i.length; e < h; e++)
                                a = i[e],
                                    g = a._name,
                                    b = a.type,
                                    b != c && (d.startGroup(f["panelTitle" + b]),
                                        c = b),
                    ...
                    onOpen: function () {
                        ...
                        for (var c in h) {
                            var d = h[c]
                                , e = d.type;
                            e == CKEDITOR.STYLE_BLOCK && !a.isContextFor(d.element) ? this.hideItem(c) : (d.checkActive(a) ? this.mark(c) : e == CKEDITOR.STYLE_OBJECT && !d.checkApplicable(a) && (this.hideItem(c),
                                g[e]--),
                                g[e]++)
                        }
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("tab", {
            init: function (c) {
                ...
                if (b)
                    c.on("key", function (a) {
                        9 == a.data.keyCode && (c.insertHtml(b),
                            a.cancel())
                    });
                if (d)
                    c.on("key", function (a) {
    ...
    (function () {
        function o(c) {
            function d(c) {
                !(0 < b.length) && (c.type == CKEDITOR.NODE_ELEMENT && z.test(c.getName()) && !c.getCustomData("selected_cell")) && (CKEDITOR.dom.element.setMarker(a, c, "selected_cell", !0),
                    b.push(c))
            }
                ...
                if (f.collapsed)
                    ...
                    for (f.guard = d; g = f.next();)
                        if ((g = g.getAscendant("td") || g.getAscendant("th")) && !g.getCustomData("selected_cell"))
                            CKEDITOR.dom.element.setMarker(a, g, "selected_cell", !0),
                                b.push(g)
                }
            }
        ...
        function m(c, d) {
            for (var b = o(c), a = b[0], e = a.getAscendant("table"), a = a.getDocument(), f = b[0].getParent(), g = f.$.rowIndex, b = b[b.length - 1], h = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = new CKEDITOR.dom.element(e.$.rows[h]), g = d ? g : h, f = d ? f : b, b = CKEDITOR.tools.buildTableMap(e), e = b[g], g = d ? b[g - 1] : b[g + 1], b = b[0].length, a = a.createElement("tr"), h = 0; e[h] && h < b; h++) {
                var i;
                1 < e[h].rowSpan && g && e[h] == g[h] ? (i = e[h],
                    i.rowSpan += 1) : (i = (new CKEDITOR.dom.element(e[h])).clone(),
        ...
        function p(c) {
            if (c instanceof CKEDITOR.dom.selection) {
                for (var d = o(c), b = d[0].getAscendant("table"), a = CKEDITOR.tools.buildTableMap(b), c = d[0].getParent().$.rowIndex, d = d[d.length - 1], e = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [], f = c; f <= e; f++) {
                    for (var g = a[f], h = new CKEDITOR.dom.element(b.$.rows[f]), i = 0; i < g.length; i++) {
                        ...
                        1 == j.$.rowSpan ? j.remove() : (j.$.rowSpan -= 1,
                            k == f && (k = a[f + 1],
                                k[i - 1] ? j.insertAfter(new CKEDITOR.dom.element(k[i - 1])) : (new CKEDITOR.dom.element(b.$.rows[f + 1])).append(j, 1)));
                        i += j.$.colSpan - 1
                    }
                    d.push(h)
                }
            ...
            c instanceof CKEDITOR.dom.element && (b = c.getAscendant("table"),
                1 == b.$.rows.length ? b.remove() : c.remove());
            return null
        }
        function q(c, d) {
        ...
        function n(c, d) {
            ...
            for (h = 0; h < g; h++)
                a[h] && (1 < a[h].colSpan && b[h] == a[h] ? (e = a[h],
                    e.colSpan += 1) : (e = (new CKEDITOR.dom.element(a[h])).clone(),
                        e.removeAttribute("colSpan"),
                        !CKEDITOR.env.ie && e.appendBogus(),
                        e[d ? "insertBefore" : "insertAfter"].call(e, new CKEDITOR.dom.element(a[h])),
                        e = e.$),
                    h += e.rowSpan - 1)
        }
        function t(c, d) {
        ...
        function s(c) {
            if (c instanceof CKEDITOR.dom.selection) {
                ...
                a: {
                    ...
                    CKEDITOR.dom.element.clearAllMarkers(e);
                    g = c[0].getParent();
                    (g = g.getPrevious()) ? b = g.getLast() : (g = c[b].getParent(),
                ...
                c instanceof CKEDITOR.dom.element && (d = c.getParent(),
                    1 == d.getChildCount() ? d.remove() : c.remove())
        }
        function u(c, d) {
                        ...
                        for (k = h; k <= i; k++)
                            for (l = 0; l < d.length; l++)
                                c = d[l],
                                    ...
                                    c.$ && (1 == c.$.colSpan ? c.remove() : c.$.colSpan -= 1,
                                        l += c.$.rowSpan - 1,
                                        b.$.cells.length || j.push(b));
    ...
    (function () {
        ...
        h.prototype = {
            type: function (a) {
                ...
                if (!(a in m || this.typing) || !c && !e && (b || g) || c && !d) {
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        ...
                        f.contents != a && h == this.snapshots.length && (this.typing = !0,
                ...
                c ? (this.typesCount = 0,
                    this.modifiersCount++ ,
                    25 < this.modifiersCount && (this.save(!1, null, !1),
                        this.modifiersCount = 1)) : e || (this.modifiersCount = 0,
                            this.typesCount++ ,
                            25 < this.typesCount && (this.save(!1, null, !1),
                                this.typesCount = 1))
            },
            reset: function () {
            ...
            restoreImage: function (a) {
                ...
                a.bookmarks ? b.selectBookmarks(a.bookmarks) : CKEDITOR.env.ie && (c = this.editor.document.getBody().$.createTextRange(),
                    c.collapse(!0),
                    c.select());
                this.locked = 0;
                this.index = a.index;
