    ...
    b[0] = {
        value: function() {
            ...
            function b(a, e, f, g, i) {
                ...
                j = function() {}, j.prototype = o.prototype, l = new j, o.apply(l, n), f.func = l;
        ...
        value: function() {
            return function(a, b, c) {
                var d = c.shift();
                return "object" == typeof d && "combination" === d.name && (d = d.operand.join("")), a.name = "text", a.attr = {
                    _reverse: "mathbb"
                }, a.callFn = {
                    setFamily: ["KF AMS BB"]
        ...
        value: function() {
            ...
            f.register("latex", f.implement({
                ...
                expand: function(a) {
                    ...
                    if (d)
                        for (var f in d) d.hasOwnProperty(f) && (h[f.replace(/\\/g, "")] = d[f])
                },
                format: function(a) {
                ...
                parseToGroup: function(a) {
                    for (var b = [], c = [b], d = 0, e = 0, f = 0, g = a.length; g > f; f++) switch (a[f]) {
                        ...
                        case "\\left":
                            e++, c.push(b), b.push([
                                []
                            ]), b = b[b.length - 1][0], b.type = "brackets", f++, b.leftBrackets = a[f].replace(q, "{").replace(r, "}");
                            break;
                        case "\\right":
        ...
        value: function() {
            return function(a) {
                var b = ["\\overrightarrow"];
//                console.log(a[1] && b.push("[" + a[1] + "]"), b.push(" " + a[0]), b.join(""))
                return a[1] && b.push("[" + a[1] + "]"), b.push(" " + a[0]), b.join("")
            }
        }
    }, b[47] = {
